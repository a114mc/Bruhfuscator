...
public class AmbienStringEncryption {
    private static final String DECRYPTOR_DESCRIPTOR = "(Ljava/lang/String;II)Ljava/lang/String;";
    public static void ambienEncryption(ClassWrapper classWrapper) {
...
//                        .filter(insn -> insn != null && insn.getOpcode() == LDC && insn instanceof LdcInsnNode)
    ...
    private static String encrypt(String str, int key1, int randSeed) {
    ...
    private static InsnList buildDecryptionRoutine(ClassWrapper classWrapper, final MethodNode arrRevNode, final MethodNode decryptionNode,
    ...
    private static MethodNode buildArrReverser() {
    ...
    private static MethodNode buildDecryptor() {
        final MethodBuilder builder = new MethodBuilder()
                .setName(StringUtil.genName(MathUtil.randomInt(10, 50)))
                .setAccess(ACC_PRIVATE | ACC_STATIC)
